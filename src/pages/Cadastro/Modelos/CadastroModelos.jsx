...
const CadastraModelo = (props) => {
    ...
    return (
        <>
            ...
            {/*MODAL CRIAR */}
            <div className={`modal ${modalIsOpen == false ? 'fade' : ''}`} id="criarModelo" tabIndex="-1" aria-labelledby="criarModeloModalLabel" aria-hidden="true"> {/*fazemos uma verificação se existe um modal */}
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Criando Modelos</h5>
