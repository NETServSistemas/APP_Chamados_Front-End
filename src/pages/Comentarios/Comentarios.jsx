...
const Comentarios = () => {
    ...
    useEffect(() => {
        const buscaComentario = async () => {
            const comentario = ChamadosTeste;
            setChamado(comentario);
        }
        buscaComentario();
    })

    const comentariosChamado = ChamadosTeste[0];
    const comentario = comentariosChamado;
                ...
                <div className='detailsComentarios'>
                    ...
                    <div className='ativos'>
                        ...
                        <div className='perifericos'>
                            {comentario.modeloPessoa[0].descricaoModelo} {comentario.modeloPessoa[0].MarcaModelo}
                        </div>
                    </div>
